...
lecture is confined to the marked editorial notes, like the one at the end of this chapter, so it is
always visible which claims belong to a speaker and which do not.

...
theorem, a conjecture worth chasing, or merely a number. The honest conclusion running through
all three strands is that the search is rarely the bottleneck. Building a cheap, exact and
...
weight drop, and $\pi(x)$ the prime counting function. None of the notation from the other
chapters carries over, since these objects are specific to this one.
...
\begin{aside}
The three strands can be read as an escalating standard of evidence, and it is worth carrying
that standard across to ordinary machine learning work. Strand I asks whether a model's attribution

...
Cho's lecture has one thesis, stated two-thirds of the way through, and it reorganises a great
deal of statistics: inference does not have to be about
...
soft, so $p(\text{identifiable} \given \varepsilon)$ becomes a quantity that can be computed and
plotted as a curve.
...
This lecture cuts against Chapter~\ref{ch:02-representational-geometry}. Isola measures whether
...
\begin{aside}
The assumption underneath all of this is easy to miss because the examples are so clean. Every learned

...
opposite directions or disagreed outright. Those deserve the most attention, since a disagreement
between people who both know the field marks a genuinely open question rather than a gap in the
notes.
...
lecture about statistics, without either speaker referencing the other. When the same argument
appears independently in three lectures it is probably load-bearing.
...
constraint, which is the lesson worth carrying into any efficiency work: the first question is what
has to move, not how many operations there are.
